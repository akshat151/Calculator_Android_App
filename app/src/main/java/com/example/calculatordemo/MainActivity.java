...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    MaterialButton buttonDivide, buttonMultiply, buttonAdd, buttonSubtract;
    MaterialButton button0, button1, button2, button3, button4, button5, button6, button7, button8, button9;
    MaterialButton buttonAC, buttonDot, buttonEqual;
    ...
    String getResult(String data){
        try{
            ...
            // Parse the result as a double to format it
            double resultValue = Double.parseDouble(finalResult);
            // Format the result to have at most two decimal places
